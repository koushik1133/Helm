...
-- Order: core+auth+quotes → approval/payments → operations/tasks →
--   control-center → workspace(P1) → leads(P2) → crm+realtime(P2b) →
--   discovery(P3) → proposal(P4) → mvp polish(P5) → dev OTP pin → seed users.
-- #########################################################################
...
-- =====================================================================
-- SOURCE: seed-users.sql  (6 team users, password 'helm' — FRESH DB only)
-- =====================================================================
